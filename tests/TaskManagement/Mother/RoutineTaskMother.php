...
final class RoutineTaskMother
{
    ...
    public static function aRoutineTask(): self
    {
        return new self();
    }
    ...
    public static function active(): RoutineTask
    {
        return self::aRoutineTask()->build();
    }

    public static function inactive(): RoutineTask
    {
        return self::aRoutineTask()->deactivated()->build();
    }

    public static function dailyRoutineTask(): RoutineTask
    {
        return self::aRoutineTask()
    ...
    public static function weeklyRoutineTask(): RoutineTask
    {
        return self::aRoutineTask()
    ...
    public static function monthlyRoutineTask(): RoutineTask
    {
        return self::aRoutineTask()
    ...
    public static function random(): RoutineTask
    {
        return self::aRoutineTask()
