 ...
 *         enabled?: bool|Param, // Default: false
 *     },
 *     refresh_token_manager?: scalar|null|Param, // Set your own service implementing RefreshTokenManagerInterface, storing the tokens however you like. Nothing Doctrine is wired when this is set, so the bundle works without it. Mutually exclusive with object_manager and dbal_connection. // Default: null
 *     object_manager?: scalar|null|Param, // The object manager service to store the tokens through, as a service id rather than the name an entity manager is configured under: an entity manager named "foo" is the service "doctrine.orm.foo_entity_manager". Defaults to doctrine.orm.entity_manager. Mutually exclusive with dbal_connection. // Default: null
 *     dbal_connection?: scalar|null|Param, // Set the DBAL connection to use for direct database access. Mutually exclusive with object_manager. // Default: null
 *     dbal_table_name?: scalar|null|Param, // The table name for refresh tokens when using DBAL // Default: "refresh_tokens"
 ...
 *         name: scalar|null|Param, // The actual column name in the database
 *         type: scalar|null|Param, // The DBAL type (integer, string, datetime, etc.)
 *     }>,
 ...
 *     cookie?: bool|array{
 *         enabled?: bool|Param, // Default: false
 *         same_site?: scalar|null|Param, // One of "none", "lax" or "strict", or empty to leave the attribute off the cookie, which is what Symfony's Cookie takes an empty value to mean. Matched without regard to case, as Cookie does. // Default: "lax"
 *         path?: scalar|null|Param, // Default: "/"
 *         domain?: scalar|null|Param, // Default: null
